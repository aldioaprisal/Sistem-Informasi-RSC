...
class Pasien extends CI_Controller
{
    ...
    public function pasien()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'pasien/pasien?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'pasien/pasien?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'pasien/pasien';
            $config['first_url'] = base_url() . 'pasien/pasien';
        }
    ...
    public function read($id) 
    {
		...
		'no_tlp' => $row->no_tlp,
            ...
            redirect(site_url('pasien/pasien'));
