...
<div id="page-wrapper">
    <div class="container-fluid">
	    ...
	    <button type="submit" class="btn btn-primary"  onclick="konfirmasiDulu()">Buat</button> 
                <script>
            function konfirmasiDulu(){
                var konfirmasi = confirm("Apakah data pasien sudah benar ?");
                var text = "";
	    ...
	    <a href="<?php echo site_url('pendaftaran/daftar') ?>" class="btn btn-default">Cancel</a>
	</form>
</div>
</div>
    </body>
