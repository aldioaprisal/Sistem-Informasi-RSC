    ...
    <div id="page-wrapper">
        ...
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('pasien/pasien'); ?>" class="form-inline" method="get">
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('pasien/read/'.$pasien->id_pasien),'<i class="fa fa-list"></i>'); 
				echo ' | '; 
				echo anchor(site_url('pasien/update/'.$pasien->id_pasien),'<i class="glyphicon glyphicon-pencil"></i>'); 
				echo ' | '; 
				echo anchor(site_url('pasien/delete/'.$pasien->id_pasien),'<i class="glyphicon glyphicon-trash"></i>','onclick="javasciprt: return confirm(\'Apakah Kamu Yakin ?\')"'); 
				?>
			</td>
		</tr>
                <?php
